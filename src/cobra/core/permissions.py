...
from cobra.core.cache import cached_for_request
from cobra.apps.organization.utils import OrganizationMemberType
...
def can_set_public_projects(user):
    ...
    if result is None:
        result = settings.COBRA_ALLOW_PUBLIC_PROJECTS
