...
from .view import PluggableViewMixin
...
class IPlugin(local, PluggableViewMixin):
    ...
    >>> from cobra.core.plugins import Plugin  # NOQA
    ...
    project_conf_template = 'cobra/plugins/project_configuration.html'

    site_conf_form = None
    site_conf_template = 'cobra/plugins/site_configuration.html'
    ...
    def reset_options(self, project=None, user=None):
        from cobra.core.plugins.helpers import reset_options
    ...
    def get_option(self, key, project=None, user=None):
        ...
        """
        from cobra.core.plugins.helpers import get_option
    ...
    def set_option(self, key, value, project=None, user=None):
        ...
        """
        from cobra.core.plugins.helpers import set_option
    ...
    def unset_option(self, key, project=None, user=None):
        ...
        """
        from cobra.core.plugins.helpers import unset_option
    ...
    def get_url(self, group):
        ...
        """
        return reverse('cobra-group-plugin-action', args=(group.organization.slug, group.project.slug, group.pk, self.slug))
    ...
    def get_resource_links(self):
        ...
        >>> def get_resource_links(self):
        >>>     return [
        >>>         ('Documentation', 'http://django-cobra.readthedocs.org'),
        >>>         ('Bug Tracker', 'https://github.com/lyoniionly/django-cobra/issues'),
        >>>         ('Source', 'https://github.com/lyoniionly/django-cobra'),
        >>>     ]
        """
        return self.resource_links

    def get_view_response(self, request, group):
        from cobra.core.permissions import can_admin_group, can_remove_group
