...
from cobra.core.strings import truncatechars
...
def trim(value, max_size=settings.COBRA_MAX_VARIABLE_SIZE, max_depth=3,
...
def trim_dict(value, max_items=settings.COBRA_MAX_DICTIONARY_ITEMS, **kwargs):
    max_items -= 1
