...
from cobra.singleton import cache
from cobra.models.query import create_or_update
from cobra.core.loading import get_model

Option = get_model('option', 'Option')
...
class OptionsManager(object):
    """
    A backend for storing generic configuration within Cobra.
    ...
    def get(self, key):
        ...
        if not result:
            ...
            result = settings.COBRA_OPTIONS.get(key)
