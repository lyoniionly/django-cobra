...
(function (app, jQuery, _) {
  ...
  app.forms.add_password_fields_reveal_buttons = function (el) {
  ...
  /*app.forms.init_examples = function (el) {
    var $el = $(el);
  ...
  app.addInitFunction(app.forms.init = function () {
    app.forms.prevent_multiple_submission($('body'));
    app.modals.addModalInitFunction(app.forms.prevent_multiple_submission);

//    app.forms.init_examples($("body"));
//    app.modals.addModalInitFunction(app.forms.init_examples);

    /*app.forms.handle_snapshot_source();
    ...
    app.modals.addModalInitFunction(
      app.forms.add_password_fields_reveal_buttons);*/

    // Bind event handlers to confirm dangerous actions.
    $("body").on("click", "form button.btn-danger:not(.no-feedback)", function (evt) {
      app.modals.confirm(this);
      evt.preventDefault();
    });

    /* Switchable Fields (See Gitgo's Forms docs for more information) */
