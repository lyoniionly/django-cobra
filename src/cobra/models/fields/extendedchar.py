...
from cobra.forms import fields

import cobra.core.phonenumber as phonenumber
...
try:
    ...
    add_introspection_rules([], ["^cobra\.models\.fields\.extendedchar\.ExtendedURLField$"])
    add_introspection_rules([], ["^cobra\.models\.fields\.extendedchar\.PositiveDecimalField$"])
    add_introspection_rules([], ["^cobra\.models\.fields\.extendedchar\.UppercaseCharField$"])
    add_introspection_rules([], ["^cobra\.models\.fields\.extendedchar\.NullCharField$"])
    add_introspection_rules([], ["^cobra\.models\.fields\.extendedchar\.PhoneNumberField$"])
    add_introspection_rules([], ["^cobra\.models\.fields\.autoslugfield\.AutoSlugField$"])

__all__ = (
    'ExtendedURLField', 'PositiveDecimalField', 'UppercaseCharField',
    'NullCharField', 'PhoneNumberField'
)
