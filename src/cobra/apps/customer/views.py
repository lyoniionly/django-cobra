...
from cobra.views.generic import PostActionMixin
from cobra.apps.customer.utils import get_password_reset_url
...
UserAddressForm = None # get_class('address.forms', 'UserAddressForm')
Order = None# get_model('order', 'Order')
Line = None#get_model('basket', 'Line')
Basket = None#get_model('basket', 'Basket')
UserAddress = None#get_model('address', 'UserAddress')
Email = get_model('customer', 'Email')
ProductAlert = None# get_model('customer', 'ProductAlert')
...
class AccountSummaryView(generic.RedirectView):
    ...
    """
    url = reverse_lazy(settings.COBRA_ACCOUNTS_REDIRECT_URL)
