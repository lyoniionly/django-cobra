...
from cobra.apps.customer.utils import normalise_email
...
# Deprecated since Cobra 1.0 because of the spelling.
class Emailbackend(EmailBackend):

    def __init__(self):
        warnings.warn(
            "Cobra's auth backend EmailBackend has been renamed in Cobra 1.0 "
